...
technology-adoption activity, tenders, and competitor developments — for the
run's `targetMarket` and `targetCustomerType`. Capture each as a discrete,
sourced claim, not as prose.
